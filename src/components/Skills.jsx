    ...
    >
      <div className="container mx-auto px-6 text-center">
        <motion.h3
          ...
          className="text-5xl font-extrabold text-[#f5c518] mb-14 drop-shadow-[0_0_12px_rgba(245,197,24,0.6)]"
        >
          Skills
        </motion.h3>
          ...
          {skills.map((s, i) => (
            <motion.div
              ...
              className="px-8 py-4 rounded-xl border border-white/10 bg-black/40 
                         ...
                         text-lg font-semibold uppercase tracking-wide backdrop-blur-md"
            >
              {s}
            </motion.div>
          ))}
